...
<div className='text-white pt-20 px-4'>
      ...
      <div className='flex flex-col md:flex-row pt-10 sm:px-20 h-fit w-full text-white bg-[#2a2a2a] '>
        <div className='sm:w-[40%] flex  justify-center items-center relative '>
          <img
        ...
        <div className='p-8 lg:pt-10 xl:p-12 flex flex-col h-full sm:w-[60%] md:gap-4 lg:gap-6 xl:gap-3 '>
          <h3 className=' text-2xl md:text-2xl lg:text-3xl xl:text-3xl 2xl:text-4xl font-bold font-[Fredoka]'>{book.title}</h3>
          <p className='font-semibold text-amber-400 text-base'>Author: {book.author}</p>
          <p className='font-semibold text-sm'>★ {book.rating}</p>
          <div className='flex gap-5 items-center py-5 sm:py-0'>
            <p className=' text-2xl  font-bold '>₹{book.priceAfterDiscount}</p>
            <p className='text-xl font-semibold'><strike>₹{book.mrp}</strike></p>
          </div>
          <p className='pb-5 sm:pb-0 font-medium'>Description: {book.description}</p>
          <div className='flex flex-col sm:flex-row gap-3 text-black font-extrabold sm:font-bold'>
      ...
      <div className='w-full h-fit py-4 md: xl:px-50 px-10 sm:px-0 bg-[#212121] text-white'>
