...

 {
      cartItems.length!=0?<><div className=' flex flex-col gap-1 my-2 h-fit px-10 md:px-0 '>
          ...
          <div><lord-icon
              ...
              width={300}
              height={300}
              className="xl:h-30 xl:w-30 md:h-15 md:w-15 sm:w-20 sm:h-20"
            >
            </lord-icon></div>
            <p className='md:text-lg lg:text-xl xl:text-2xl text-xl sm:font-bold'>Your cart is empty!</p>
        ...
        <div className='w-[50%] md:px-10 h-fit pt-20 md:ml-5 mx-auto   '>
          <div>
            <span className='md:text-lg xl:text-xl sm:text-xl font-bold'>Price Summary</span>
          </div>
          <div className='px-3'>

            <div className='flex justify-between items-center md:text-sm lg:text-base xl:text-lg sm:text-lg font-medium text-[#bcbcbc]'>
              <p>Order Total</p>
              <p> ₹ {totalMRP}.00</p>
            </div>
            <div className='flex justify-between items-center md:text-sm lg:text-base xl:text-lg sm:text-lg font-medium text-[#bcbcbc]'>
            ...
            <div className='flex justify-between items-center md:text-base lg:text-lg  xl:text-xl sm:text-xl font-bold my-4 '>
              <p>To Pay</p>
