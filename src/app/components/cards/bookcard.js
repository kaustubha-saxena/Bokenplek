...
const Bookcard = ({props}) => {
  ...
  document.documentElement.scrollTop = 0;
        ...
        {
          props.tag ==="Best Seller"?<div className='w-15 absolute top-[-15px] right-[-15px]'><img src="/icons/best-seller.png" alt="" /></div>:<></>
        }
        
          <div className=' '>
              <img className='w-full rounded-xl' src={`/books/${props.genre}/${props.imgName}.png`} alt="Book Cover Page" />
